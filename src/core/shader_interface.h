...
constexpr int GBUFFER_DEPTH_TEX                     = 9;
constexpr int GBUFFER_DIFFUSE_NORMAL_TEX            = 10;
constexpr int GBUFFER_SPECULAR_GLOSSY_EMISSIVE_TEX  = 11;
constexpr int BRICK_TEX                             = 12;
